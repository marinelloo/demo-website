...
+ Добавьте файл `hw_2.js`
+ Добавьте туда `console.log('Hello World!')`
+ Затем используя команду `git add hw_2.js` внесите изменения в индекс
...
+ Напишите заголовок своего первого `pull request` => `[HW1] name description`
